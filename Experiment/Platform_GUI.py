...
# Stop_Flag = 0
# # Attack_Flag = 0
# # No_Attack_Complete_Flag = 0
# global Selected_Use_Case
# global Selected_Apply_option
# global Selected_Opt_Technique
# # global root
# choices = {}
...
#         #     print("Run use cases without optimization function")
#         #
#         # # Run use cases as per selection
#         # if "Anti Lock Braking System" in choices:
#         #     print("Running ABS")
#         # elif "Traction Control System" in choices:
#         #     print("Running TCS")
#         # elif "Right Turn and Return to Centre" in choices:
#         #     print("Running RT+RTC")
#         # elif "Cruise Control" in choices:
#         #     print("Running Cruise Control")
#         # elif "Tire Pressure Monitoring System" in choices:
#         #     print("Running TPMS")
#         # if Stop_Flag == 1:
#         #     root.after(2000, lambda: showerror("error", "Stopping current functionality"))
...
#     # Creating Menubar
#     menubar = Menu(root)
#     print("Printing line 118")
#     # Adding Attack Menu and commands
#     MyMenu = Menu(menubar, tearoff=0)
#     menubar.add_cascade(label='Run Use Cases', menu=MyMenu)
#     menubar.add_cascade(label='Create New Use Case', menu=MyMenu)
#     #attack.add_command(label='Sensor Attack', command=Sensor_Attack)
#     #----------------------------------------------------------------------------
#     ##### User will select the use cases that needs to be run
#     #----------------------------------------------------------------------------
...
#     Field2 = Combobox(root, width = 50, value=options2)
#     Field2.current()
#     Field2.bind("<<Combobox2selected>>", Selected_Apply_option)
#     Field2.pack()
#
#     # #Error if different status
#     Selected_Status = Field2.get()
#
#     #----------------------------------------------------------------------------
#     ##### Ask user which optimization technique should be applied
#     #----------------------------------------------------------------------------
...
#                 'None')
#     #SensorChosen.grid(column= 1, row= 3)
#     Field3 = Combobox(root, width = 50, value=options2)
#     Field3.current()
#     Field3.bind("<<Combobox2selected>>", Field3)
#     Field3.pack()
#
...
# #            'Right Turn and Return to Centre',
# #            'Cruise Control', 'Tire Pressure Monitoring System')
# #
...
# # SensorChosen.pack()
# #
# # # #Error if different sensor
# # Selected_Sensor = SensorChosen.get()
# #
# # # if Selected_Sensor != 'HC-SR04':
# # #     showerror("Error", "Selected Type of Sensor is different from the Victim Sensor")
# #-----------------------------------------------------------------------------------
#
# ## Plain text box sample code---------------------------------------------------
#
...
# # Box_Baud.focus_set()
# #
# # # #Error if different rate
# # Selected_Baud_Rate = Box_Baud.get()
